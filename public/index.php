...
$router->get('/teste_crud.html', function() {
    require ROOT_PATH . '/teste_crud.html';
});

$router->get('/cadastro_ultimate.html', function() {
    require ROOT_PATH . '/cadastro_ultimate.html';
});

$router->get('/login_test.html', function() {
    require ROOT_PATH . '/login_test.html';
});
...
// Rota de teste final para cadastro
$router->post('/api/test-register', function() {
    require ROOT_PATH . '/final_test_register.php';
});
